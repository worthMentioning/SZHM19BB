                                        ...
                                        <dd>
                                            <div class="stock-box">
                                                <div class="el-input-number el-input-number--small">
                                                    <span
                                                        :class="{'is-disabled':buyNum==1}"
                                                        role="button"
                                                        class="el-input-number__decrease is-disabled"
                                                    >
                                                        <i
                                                            @click="buyNum==1? 1 : buyNum--"
                                                            class="el-icon-minus"
                                                        ></i>
                                                    </span>
                                                    <span
                                                        :class="{'is-disabled':buyNum== goodsinfo.stock_quantity}"
                                                        role="button"
                                                        class="el-input-number__increase"
                                                    >
                                                        <i
                                                            @click="buyNum==goodsinfo.stock_quantity? goodsinfo.stock_quantity : buyNum++"
                                                            class="el-icon-plus"
                                                        ></i>
                                                    </span>
                        ...
                        <div id="goodsTabs" class="goods-tab bg-wrap">
                            ...
                            >
                                <ul>
                                    <li>
                                        <a
                                            @click="isShowDec = true;"
                                            href="javascript:;"
                                            :class="{selected:isShowDec}"
                                        >商品介绍</a>
                                    </li>
                                    <li>
                                        <a
                                            @click="isShowDec = false;"
                                            href="javascript:;"
                                            :class="{selected:!isShowDec}"
                                        >商品评论</a>
                                    </li>
